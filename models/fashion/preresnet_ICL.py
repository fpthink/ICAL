...
class WeightNorm(object):
    ...
    def apply(module, name, dim):
        ...
        module.register_parameter(name + '_v', Parameter(fn.norm(weight).data))
...
class PreResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes=1000):
        ...
        self.fc = WeightNorm.apply(nn.Linear(64 * block.expansion, num_classes, False), name='weight')
